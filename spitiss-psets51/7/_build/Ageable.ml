...
object (self)
  ...
  method private draw_life : unit =
    (* the below line stops a random crash... 
     * I'm really confused as to why the crash was happening; I determined that
     * lifetime was getting here with a negative value,
     * but that makes zero sene to me - I must be missing something *)
    if lifetime <= 0 then self#die else
  ...
  (* ### TODO: Part 4 Aging ### *)
  method private draw_picture : unit =
    self#draw_circle Graphics.green Graphics.black ""
